[Arc framework](github.com/Anuken/Arc/) without client related things, fixed bugs and with new api and features.
...
```
Add the framework to your project dependencies *(the versioning follows Arc's one)*:
```gradle
dependencies {
  implementation 'com.xpdustry:arc-lite:v158.1'
}
```
...
Optionally, to be able to use colors on Windows consoles *(e.g. the cmd)*, you'll need to include some libraries to your project dependencies:
```gradle
dependencies {
...
<details>
  ...
  <ul>
    ...
    <li><code><a href="https://github.com/Anuken/Arc/tree/master/arc-core/src/arc/util/ArcNativesLoader.java">arc.util.ArcNativesLoader</a></code></li>
    <li><code><a href="https://github.com/Anuken/Arc/tree/master/arc-core/src/arc/util/Buffers.java">arc.util.Buffers</a></code></li>
...
<details>
  <summary><strong>Fixed classes warnings</strong></summary>
  <ul>
    ...
    <li><code><a href="https://github.com/Anuken/Arc/blob/master/arc-core/src/arc/math/geom/QuadTree.java">arc.math.geom.QuadTree</a></code></li>
...
<details>
  ...
  <ul>
    ...
    <li><code><a href="https://github.com/xpdustry/arc-lite/blob/master/src/main/java/arc/Graphics.java">arc.Graphics</a></code>: deprecated the class</li>
    ...
    <li><code><a href="https://github.com/Anuken/Arc/blob/master/arc-core/src/arc/mock/MockGraphics.java">arc.mock.MockGraphics</a></code>: deprecated the class</li>
    <li><code><a href="https://github.com/xpdustry/arc-lite/blob/master/src/main/java/arc/graphics/Pixmap.java">arc.graphics.Pixmap</a></code>: removed GL related classes</li>
    ...
    <li><code><a href="https://github.com/xpdustry/arc-lite/blob/master/src/main/java/arc/net/Connection.java">arc.net.Connection</a></code>: changed some private field to protected, added a listener dispatcher</li>
    <li><code><a href="https://github.com/xpdustry/arc-lite/blob/master/src/main/java/arc/net/Server.java">arc.net.Server</a></code>: changed some private field to protected, added a listener dispatcher</li>
    ...
    <li><code><a href="https://github.com/xpdustry/arc-lite/blob/master/src/main/java/arc/util/TaskQueue.java">arc.util.TaskQueue</a></code>: replaced by a lock-less implementation</li>
...
<details>
  ...
  <ul>
    ...
    <li><code><a href="https://github.com/xpdustry/arc-lite/blob/master/src/main/java/arc/util/Ratekeeper.java">arc.util.Ratekeeper</a></code>: changed millis to nanos time calculation.</li>
    ...
    <li><code><a href="https://github.com/xpdustry/arc-lite/blob/master/src/main/java/arc/util/Timekeeper.java">arc.util.Timekeeper</a></code>: added methods to know elapsed time, remaining time, etc, and changed millis to nanos time calculation.</li>
    ...
    <li><code><a href="https://github.com/xpdustry/arc-lite/blob/master/src/main/java/arc/util/Time.java">arc.util.Time</a></code>: added features from <a href="https://github.com/mindustry-antigrief/Arc">foo's Arc</a> and other api to simplify time conversion.</li>
    <li><code><a href="https://github.com/xpdustry/arc-lite/blob/master/src/main/java/arc/util/Timer.java">arc.util.Timer</a></code>: added ability to reschedule a task</li>
    <li><code><a href="https://github.com/xpdustry/arc-lite/blob/master/src/main/java/arc/struct">arc.struct.*</a></code>: added features from <a href="https://github.com/mindustry-antigrief/Arc">foo's Arc</a>, made all classes iterator compatible, added <code>each()</code> methods.</li>
  </ul>
</details>
