...
public class CommandHandler{
    ...
    public <T> Command register(String text, String params, String description, CommandRunner<T> runner){
        ...
        Command cmd = new Command(text, params, description, (CommandRunner<Object>)runner);
    ...
    public static class Command{
        ...
        final CommandRunner<Object> runner;

        public Command(String text, String paramText, String description, CommandRunner<Object> runner){
            this.text = text;
