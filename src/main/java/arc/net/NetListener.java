...
public interface NetListener{
     ...
     * {@link Server#update(int)}.
     * This method should not block for long periods as other network activity
     ...
     * connection.
     * This will be invoked on the same thread as {@link Client#update(int)}
     * and {@link Server#update(int)}.
     * This method should not block for long periods as other network activity
     * will not be processed until it returns.
     */
     ...
     */
    public abstract class QueuedListener implements NetListener{
     ...
     */
    public class ThreadedListener extends QueuedListener{
     ...
     * Notification events are processed on a separate thread after a delay.
     * Note that only incoming objects are delayed.
     * To delay outgoing objects, use a LagListener at the other end of the connection.
     */
    public class LagListener extends QueuedListener{
