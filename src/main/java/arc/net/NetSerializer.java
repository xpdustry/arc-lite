 ...
 * transmissions and the <i>same</i> instance for UDP ones.
 * Therefore all implementing classes have to be synchronized or made thread-safe otherwise.
 */
public interface NetSerializer{
     ...
     * {@link #writeLength(ByteBuffer, int)}
     * and read by {@link #readLength(ByteBuffer)}.
     */
